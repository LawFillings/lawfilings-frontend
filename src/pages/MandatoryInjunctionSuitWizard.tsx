      ...
      >
        ...
        {step === 2 && (
          <div>
            ...
            <DocumentAutofill
              documentLabel={'agreement, notice or document creating the obligation'}
              fields={[
                { key: 'obligationDescription', label: 'The obligation the defendant failed to perform', value: obligationDescription, set: setObligationDescription },
