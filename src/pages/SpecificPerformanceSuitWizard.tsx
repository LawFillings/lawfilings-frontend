      ...
      >
        ...
        {step === 2 && (
          <div>
            ...
            <DocumentAutofill
              documentLabel={'agreement or contract'}
              fields={[
                { key: 'contractDescription', label: 'The contract: type, date, parties and main terms', value: contractDescription, set: setContractDescription },
              ]}
            />
