          ...
          <div>
            ...
            <DocumentAutofill
              ...
              fields={[
                ...
                { key: 'firDate', label: 'Date of the FIR', kind: 'date', value: firDate, set: setFirDate },
                { key: 'offenceSections', label: 'Offence sections cited, exactly as written', value: offenceSections, set: setOffenceSections },
                { key: 'petitionerName', label: 'the accused named in the FIR (who wants it quashed)', value: petitionerName, set: setPetitionerName },
                { key: 'petitionerAge', label: 'Age of the accused named in the FIR (who wants it quashed)', kind: 'amount', hint: 'digits only', value: petitionerAge, set: setPetitionerAge },
                { key: 'petitionerAddress', label: 'Address of the accused named in the FIR (who wants it quashed)', value: petitionerAddress, set: setPetitionerAddress },
              ]}
            />
